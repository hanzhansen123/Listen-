//
//  BaiJiaJiangTanViewController.m
//  CeShiButton
//
...
#import "BaiJiaJiangTanViewController.h"
...
@interface BaiJiaJiangTanViewController () <HTHorizontalSelectionListDataSource, HTHorizontalSelectionListDelegate,UIScrollViewDelegate>
@property (strong, nonatomic) HTHorizontalSelectionList *SelectList;
@property (nonatomic, strong) NSArray *ListArray;
@property (strong, nonatomic) IBOutlet UIScrollView *ScrollView;
@end

@implementation BaiJiaJiangTanViewController
...
- (void)layoutSelectionListView
{
    ...
    self.ListArray = @[@"推荐", @"名师经典",@"历史传奇", @"帝王将相",  @"风云人物", @"国学经典"];
...
- (IBAction)ToPlayView:(UIBarButtonItem *)sender {
