...
@interface YinYueViewController () <HTHorizontalSelectionListDataSource, HTHorizontalSelectionListDelegate,UIScrollViewDelegate>
...
@implementation YinYueViewController
...
- (void)layoutSelectionListView
{
    ...
    self.ListArray = @[@"推荐", @"精选|歌单",@"欧美|其他", @"日语|韩语",  @"艺人|明星", @"孤单.伤感", @"睡前.催眠", @"|纯音乐|", @"|小清新|", @"流行", @"摇滚", @"节奏.运动", @"古风", @"摇滚"];
