...
@interface XiangShengViewController () <HTHorizontalSelectionListDataSource, HTHorizontalSelectionListDelegate,UIScrollViewDelegate>
...
@implementation XiangShengViewController
...
- (void)layoutSelectionListView
{
    ...
    self.ListArray = @[@"推荐", @"郭德纲",@"天津相声", @"赵本山",  @"单田芳", @"袁阔成", @"德云社", @"相声大全", @"评书", @"小品", @"相声名家", @"小品王"];
...
- (IBAction)ToPlayerView:(UIBarButtonItem *)sender {
